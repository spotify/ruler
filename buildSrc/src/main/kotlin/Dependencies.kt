...
object Dependencies {
    ...
    const val ROUTING_COMPOSE = "app.softwork:routing-compose:${Versions.ROUTING_COMPOSE}"
    ...
    object Versions {
        ...
        const val KOTLINX_SERIALIZATION = "1.5.0" // https://mvnrepository.com/artifact/org.jetbrains.kotlinx/kotlinx-serialization-core
        ...
        const val KOTLIN_JS_EXTENSIONS = "1.0.1-pre.519" // https://mvnrepository.com/artifact/org.jetbrains.kotlin-wrappers/kotlin-extensions
        const val ROUTING_COMPOSE = "0.2.12"
        ...
        const val APEX_CHARTS = "3.35.5" // https://www.npmjs.com/package/apexcharts
    }
}
