...
object Dependencies {
    ...
    object Versions {
        ...
        const val PROTOBUF = "3.19.1" // https://mvnrepository.com/artifact/com.google.protobuf/protobuf-java
        const val DEXLIB = "2.5.2" // https://mvnrepository.com/artifact/org.smali/dexlib2

        const val ANDROID_TOOLS = "30.0.3" // https://mvnrepository.com/artifact/com.android.tools/common?repo=google
        const val KOTLINX_SERIALIZATION = "1.3.0" // https://mvnrepository.com/artifact/org.jetbrains.kotlinx/kotlinx-serialization-core
        const val SNAKE_YAML = "1.29" // https://mvnrepository.com/artifact/org.yaml/snakeyaml

        const val JUNIT = "5.8.1" // https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-engine
        ...
        const val KOTLIN_REACT = "17.0.2-pre.264-kotlin-1.5.31" // https://mvnrepository.com/artifact/org.jetbrains.kotlin-wrappers/kotlin-react
        const val KOTLIN_REACT_ROUTER = "5.3.0-pre.264-kotlin-1.5.31" // https://mvnrepository.com/artifact/org.jetbrains.kotlin-wrappers/kotlin-react-router-dom
        const val KOTLIN_JS_EXTENSIONS = "1.0.1-pre.264-kotlin-1.5.31" // https://mvnrepository.com/artifact/org.jetbrains.kotlin-wrappers/kotlin-extensions
        ...
        const val APEX_CHARTS = "3.29.0" // https://www.npmjs.com/package/apexcharts
    }
}
