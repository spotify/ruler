...
/** Testing robot specifically for the dynamic features page. */
class DynamicFeaturesRobot(driver: WebDriver) : BaseRobot<DynamicFeaturesRobot>(driver) {
    override fun self() = this

    /** Assets that the size displayed for a given [feature] matches the expected [size]. */
    fun assertFeatureSize(feature: String, size: String) = apply {
        val ancestor = driver.findElement(ancestor(feature))
